...
urlpatterns = [
    ...
    path('expertise/folder/custom-fields/', views.CustomFieldViewSet.as_view(), name='custom-fields'),
    path('expertise/folder/folder-data/', views.FolderDataViewSet.as_view(), name='folder-data'),
    path('expertise/folder/custom-fields/list/', views.CustomFieldListViewSet.as_view(), name='custom-fields-list'),
    ...
    path('tasks/list/', views.TaskListView.as_view(), name='task-list'),
